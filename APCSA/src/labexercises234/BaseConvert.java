...
//****************************************************************
// BaseConvert.java                      Project or Lab Name: Lab Exercises 2.3 - 2.4
//
...
public class BaseConvert {
    ...
    public static void main (String[] args)
    {
        ...
        System.out.println("Maximum 4-digit base 10 number with the given power: " + maxNumber);
        ...
        System.out.println("Base conversion from Base 10 to Base " + base + ": " + baseBNum);
